...
#SBATCH --job-name=fastqc_concat                # Name for job (shows when running squeue)
...
### running fastqc on trimmed, concatenated reads ###
fastqc -o fastqc/ --noextract /hb/groups/kelley_lab/tina/mytilus/02_trim/final_trim0603/concat/*.fq.gz -t 8