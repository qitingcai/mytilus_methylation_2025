...
### Aim of this script: paired-end 65 bp hard trim on all raw RRBS files ###

### loading trimgalore, -> contains TrimGalore version 0.6.10 ###
module load trimgalore 

### Define the input directory containing the all raw FASTQ files (4 lanes each for reverse/forward for each sample) ###
...
for file1 in $INPUT_DIR/*_R1_001.fastq.gz; do
    ...
    # Loop through each lane (L001 to L004) to do paired-end trimming
