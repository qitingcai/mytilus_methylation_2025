...
### running multiqc on all fastqc results to create aggregated results for easier viewing ###
multiqc -v -o multiqc/ /hb/groups/kelley_lab/tina/mytilus/02_trim/final_trim0603/concat/fastqc/