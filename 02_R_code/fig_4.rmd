...
cor_test <- cor.test(merged_no_outlier$Foot_Origin, merged_no_outlier$Foot_Origin, method = "pearson")
cor_test

cor_test <- cor.test(merged_no_outlier$Foot_Transplant, merged_no_outlier$Gill_Transplant, method = "pearson")
cor_test
