...
# How many mussels?
nrow(as.data.frame(table(shell_df$sample.ID)))

# Are any IDs under or overrepresented?
table(shell_df$sample.ID)
...
# Regression coefficients for pre- vs. post-transplant shell length
summary(lm(`LENGTH_FINAL..mm.` ~ `LENGTH_INIT..mm.`, data = shell_df))
