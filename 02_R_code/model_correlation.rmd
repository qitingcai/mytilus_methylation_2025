...
all_CpG_dm_gill<-read_csv("gill_unique_all_CpG.csv") %>% 
  mutate(tissue = "gill",
         model ="no_interaction")
all_CpG_dm_foot<-read_csv("foot_unique_all_CpG.csv") %>% 
  mutate(tissue ="foot",
         model = "no_interaction")
...
interaction_all_CpG_dm_foot<-read_csv("foot_interaction_all_CpG_dm.csv") %>% 
  mutate(tissue ="foot",
         model = "interaction")
interaction_all_CpG_dm_gill<-read_csv("gill_interaction_all_CpG_dm.csv") %>% 
  mutate(tissue = "gill",
         model="interaction")
