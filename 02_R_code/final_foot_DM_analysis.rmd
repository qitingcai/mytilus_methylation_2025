...
files_foot <- paste0("archive/", Sample_foot,".CpG_report.merged_CpG_evidence.cov.CpG_report.merged_CpG_evidence.cov")
...
wilcox_effsize(data = lrt_trans_foot$table,
